...
echo "
You are about to create symlinks for LG .htaccess Generator
-----------------------------------------------------------
...
# extensions
ln -s "$dirname"/system/extensions/ext.lg_htaccess_generator_ext.php "$ee_path"/"$ee_system_folder"/extensions/ext.lg_htaccess_generator_ext.php

# lib
ln -s "$dirname"/system/lib/lg_htaccess_generator "$ee_path"/"$ee_system_folder"/lib

# language
ln -s "$dirname"/system/language/english/lang.lg_htaccess_generator_ext.php "$ee_path"/"$ee_system_folder"/language/english/lang.lg_htaccess_generator_ext.php